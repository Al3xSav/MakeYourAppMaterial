...
public class ArticleDetailFragment extends Fragment implements
    ...
    private int mMutedColor = 0xFF4682B4;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mCollapsingToolbarLayout = mRootView.findViewById(R.id.collapsing_details);
        ...
        mAppBarLayout = mRootView.findViewById(R.id.appbar_details);
        ...
        mFloatingActionButton = mRootView.findViewById(R.id.fab_share);
                    ...
                    .get(mCursor.getString(ArticleLoader.Query.PHOTO_URL), new ImageLoader.ImageListener() {
                        ...
                        public void onResponse(ImageLoader.ImageContainer imageContainer, boolean b) {
                            ...
                            if (bitmap != null) {
                                ...
                                mMutedColor = palette.getDarkMutedColor(0xFF4682B4);
